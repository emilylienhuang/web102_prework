...
console.log("Total contributions:", totalContributions); // <== you should see a number here
...
const raisedTotal = GAMES_JSON.reduce((acc, game) => acc + game.pledged, 0);

raisedCard.innerHTML = `$${raisedTotal.toLocaleString()}`;
